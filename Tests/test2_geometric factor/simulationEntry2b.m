...
MP.resultsFileName = 'test2b';
MP.filePrefix      = 'test2b_';
...
% choose between loading preciously calcuated coefficients and calcuating the coefficients in the current simulation                                  
