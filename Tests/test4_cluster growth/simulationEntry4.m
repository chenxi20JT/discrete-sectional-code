...
MP.resultsFileName = 'test4';
MP.filePrefix      = 'test4_';
...
MP.CONST_MONOMER   = true;  % if this is true, the monomer concentration will remain constant throught the simulation
MP.COAG_OFF        = true;   % if this is true, coagualtion between clusters will be turned off
